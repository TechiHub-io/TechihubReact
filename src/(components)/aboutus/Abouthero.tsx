  ...
  return (
    <section className='relative bg-[url(/images/aboutus/herobg.svg)] bg-no-repeat bg-center lg:bg-none'>
      <img
          ...
          className='hidden lg:block absolute top-[-2px] left-0 object-cover min-[1560px]:hidden'
          width="100%"
          height="733px"
          alt='gradient'
        />
      ...
      <h1 className='max-w-[842px] text-center lg:text-left text-[#fff] min-[1560px]:text-[#000]'>
        About us
      </h1>
      <div className='flex items-center lg:items-start flex-col gap-[34px] lg:gap-[68px] max-w-[539px]'>
        <p className='text-center lg:text-left text-[#fff] min-[1560px]:text-[#000]'>
        ...
        <div className='flex flex-col lg:flex-row gap-[20px] justify-between !text-[#fff] min-[1560px]:!text-[#000]'>
