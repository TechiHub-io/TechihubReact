    ...
    <main className='max-w-[1330px] mx-auto w-[90%]'>
      <section className='flex flex-col lg:flex-row justify-between lg:px-[19px] gap-[32px] lg:gap-0'>
        <div className='flex flex-col gap-[12px]'>
            <h4 className='text-[24px] leading-[120%] font-[400]'>
              title
            </h4>
        ...
        <aside className='flex flex-col w-[100%] max-w-[617px] gap-[32px]'>
          <div className=' h-[160px] flex justify-between w-full border-[#E7F0FA] border-[2px]'>
            <div className='flex p-[32px] items-center justify-center text-center flex-col gap-[12px]'>
              ...
              <p className='text-[#0BA02C] text-[20px] font-medium'>
                salary
              </p>
          ...
          <div className='py-[32px] px-[23px] border-[#518EF8] border-[2px] rounded-[8px]'>
            <div className='flex flex-col gap-[20px] '>
              ...
              <div className='flex gap-[16px]'>
                <div className='flex items-center justify-center text-center flex-col gap-[12px] p-[32px] '>
                  <p className=''>
                  <svg className='text-[#88FF99]' xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" viewBox="0 0 24 24"><path fill="currentColor" d="M19 3h-1V1h-2v2H8V1H6v2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14c1.11 0 2-.89 2-2V5a2 2 0 0 0-2-2m0 16H5V9h14zm0-12H5V5h14z"/></svg>
                  </p>
                  <p className='text-[16px] font-medium text-[#18191C]'>
                    Job Posted:
                  </p>
                ...
                <div className='flex items-center justify-center text-center flex-col gap-[12px] p-[32px] '>
                  <p className=''>
                  <svg className='text-[#88FF99]' xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" viewBox="0 0 256 256"><path fill="currentColor" d="M230.91 172a8 8 0 0 1-2.91 10.91l-96 56a8 8 0 0 1-8.06 0l-96-56A8 8 0 0 1 36 169.09l92 53.65l92-53.65a8 8 0 0 1 10.91 2.91M220 121.09l-92 53.65l-92-53.65a8 8 0 0 0-8 13.82l96 56a8 8 0 0 0 8.06 0l96-56a8 8 0 1 0-8.06-13.82M24 80a8 8 0 0 1 4-6.91l96-56a8 8 0 0 1 8.06 0l96 56a8 8 0 0 1 0 13.82l-96 56a8 8 0 0 1-8.06 0l-96-56A8 8 0 0 1 24 80m23.88 0L128 126.74L208.12 80L128 33.26Z"/></svg>
                  </p>
                  <p className='text-[16px] font-medium text-[#18191C]'>
                   Job Level:
                  </p>
              ...
              <div className='flex gap-[16px]'>
                ...
                <div className='flex items-center justify-center text-center flex-col gap-[12px] p-[32px] '>
                  <p className=''>
                  <svg xmlns="http://www.w3.org/2000/svg" className='text-[#88FF99]' width="32px" height="32px" viewBox="0 0 256 256"><g fill="currentColor"><path d="M224 118.31V200a8 8 0 0 1-8 8H40a8 8 0 0 1-8-8v-81.69A191.14 191.14 0 0 0 128 144a191.08 191.08 0 0 0 96-25.69" opacity="0.2"/><path d="M104 112a8 8 0 0 1 8-8h32a8 8 0 0 1 0 16h-32a8 8 0 0 1-8-8m128-40v128a16 16 0 0 1-16 16H40a16 16 0 0 1-16-16V72a16 16 0 0 1 16-16h40v-8a24 24 0 0 1 24-24h48a24 24 0 0 1 24 24v8h40a16 16 0 0 1 16 16M96 56h64v-8a8 8 0 0 0-8-8h-48a8 8 0 0 0-8 8ZM40 72v41.62A184.07 184.07 0 0 0 128 136a184 184 0 0 0 88-22.39V72Zm176 128v-68.37A200.25 200.25 0 0 1 128 152a200.19 200.19 0 0 1-88-20.36V200z"/></g></svg>
                  </p>
                  <p className='text-[16px] font-medium text-[#18191C]'>
                    Education
                  </p>
              ...
              <div className='flex flex-col gap-[8px] '>
                ...
                <div className='flex gap-[8px]'>
                  <div className='bg-[#E7F0FA] flex gap-[8px] rounded-[4px] px-[16px] py-[8px]'>
                    <svg xmlns="http://www.w3.org/2000/svg" className='text-[#88FF99]' width="24px" height="24px" viewBox="0 0 256 256"><path fill="currentColor" d="M165.66 90.34a8 8 0 0 1 0 11.32l-64 64a8 8 0 0 1-11.32-11.32l64-64a8 8 0 0 1 11.32 0M215.6 40.4a56 56 0 0 0-79.2 0l-30.06 30.05a8 8 0 0 0 11.32 11.32l30.06-30a40 40 0 0 1 56.57 56.56l-30.07 30.06a8 8 0 0 0 11.31 11.32l30.07-30.11a56 56 0 0 0 0-79.2m-77.26 133.82l-30.06 30.06a40 40 0 1 1-56.56-56.57l30.05-30.05a8 8 0 0 0-11.32-11.32L40.4 136.4a56 56 0 0 0 79.2 79.2l30.06-30.07a8 8 0 0 0-11.32-11.31"/></svg>
                    <p className='text-[16px] text-[#0CCE68]'>Copy Links</p>
                  </div>
                  <p className='bg-[#E7F0FA] p-[10px] flex justify-center items-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" className='text-[#0CCE68]' width="20px" height="20px" viewBox="0 0 16 16"><path fill="currentColor" fillRule="evenodd" d="M3 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2zm1.102 4.297a1.195 1.195 0 1 0 0-2.39a1.195 1.195 0 0 0 0 2.39m1 7.516V6.234h-2v6.579zM6.43 6.234h2v.881c.295-.462.943-1.084 2.148-1.084c1.438 0 2.219.953 2.219 2.766c0 .087.008.484.008.484v3.531h-2v-3.53c0-.485-.102-1.438-1.18-1.438c-1.079 0-1.17 1.198-1.195 1.982v2.986h-2z" clipRule="evenodd"/></svg>
                  </p>
                  <p className='bg-[#0CCE68] p-[10px] flex justify-center items-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" className='text-[#fff]' width="20px" height="20px" viewBox="0 0 24 24"><path fill="currentColor" d="M20 12.05a8 8 0 1 0-9.25 8v-5.67h-2v-2.33h2v-1.77a2.83 2.83 0 0 1 3-3.14a11.92 11.92 0 0 1 1.79.16v2h-1a1.16 1.16 0 0 0-1.3 1.26v1.51h2.22l-.36 2.33h-1.85V20A8 8 0 0 0 20 12.05"/></svg>
                  </p>
                  <p className='bg-[#E7F0FA] p-[10px] flex justify-center items-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" className='text-[#0CCE68]' width="20px" height="20px" viewBox="0 0 16 16"><path fill="currentColor" d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334q.002-.211-.006-.422A6.7 6.7 0 0 0 16 3.542a6.7 6.7 0 0 1-1.889.518a3.3 3.3 0 0 0 1.447-1.817a6.5 6.5 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.32 9.32 0 0 1-6.767-3.429a3.29 3.29 0 0 0 1.018 4.382A3.3 3.3 0 0 1 .64 6.575v.045a3.29 3.29 0 0 0 2.632 3.218a3.2 3.2 0 0 1-.865.115a3 3 0 0 1-.614-.057a3.28 3.28 0 0 0 3.067 2.277A6.6 6.6 0 0 1 .78 13.58a6 6 0 0 1-.78-.045A9.34 9.34 0 0 0 5.026 15"/></svg>
                  </p>
                  <p className='bg-[#E7F0FA] p-[10px] flex justify-center items-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" className='text-[#0CCE68]' width="20px" height="20px" viewBox="0 0 36 36"><path fill="currentColor" d="M32 6H4a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h28a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2m-1.54 22H5.66l7-7.24l-1.44-1.39L4 26.84V9.52l12.43 12.37a2 2 0 0 0 2.82 0L32 9.21v17.5l-7.36-7.36l-1.41 1.41ZM5.31 8h25.07L17.84 20.47Z" className="clr-i-outline clr-i-outline-path-1"/><path fill="none" d="M0 0h36v36H0z"/></svg>
                  </p>
                </div>
              </div>       
            </div>
...
const fetcher = (url: string) => axios.get(url).then((res) => res.data.data.job);
